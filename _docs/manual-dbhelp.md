...
> **Przykład:** Sprawdzenie czy suma planowana (atrybut nagłówka `sumap` nie jest większa niż 10 000.
> Wpis w procedurze:
> ```sql
...
> **Uwaga:** Można łatwo sprawdzić  jakie parametry są przekazywane do procedury. Wystarczy na początku wpisać atrybuty do technicznej tabeli przez polecenie:
> ```sql
...
> **Przykład:** Alarm pokazujący niezaksięgowane faktury w ERP.
> 
> Założenia: 
> -  Id klasy faktura: `6`
...
**Opis:** Przed wywołanie procedury tworzona jest tabela tymczasowa o nazwie `#NVALUES`
> **Przykład:** 
> | pcode | pvalue |
> | --- | --- |
...
> **Przykład:** Z numeru dokumentu należy usunąć wszystko, co nie jest cyfrą albo znakami `/-\`. Id klasy = `6`
> 
...
**Opis:** Przed wywołanie procedury tworzona jest tabela tymczasowa o nazwie `#LINEVALUES` zawierająca wszystkie wartości wybranej kolumny
> **Przykład:** 
